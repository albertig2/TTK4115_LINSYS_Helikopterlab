...
#ifndef RTW_HEADER_simulink_wo_integrator_h_
#define RTW_HEADER_simulink_wo_integrator_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef simulink_wo_integrator_COMMON_INCLUDES_
#define simulink_wo_integrator_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                             /* simulink_wo_integrator_COMMON_INCLUDES_ */

#include "simulink_wo_integrator_types.h"
...
#define simulink_wo_integrator_rtModel RT_MODEL_simulink_wo_integrat_T
...
/* Block signals for system '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
typedef struct {
...
typedef struct {
  ...
  real_T Gain1[3];                     /* '<S11>/Gain1' */
  real_T Sum_c;                        /* '<S5>/Sum' */
  real_T Sum1;                         /* '<S5>/Sum1' */
  real_T K_ei;                         /* '<S9>/K_ei' */
  uint8_T StreamCall1_o2;              /* '<S11>/Stream Call1' */
  B_Gyrovectortopitchrateelevat_T sf_Gyrovectortopitchrateeleva_h;
           /* '<S5>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  B_Gyrovectortopitchrateelevat_T sf_Gyrovectortopitchrateelevati;
         /* '<Root>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
} B_simulink_wo_integrator_T;
...
#define rtB                            simulink_wo_integrator_B
#define BlockIO                        B_simulink_wo_integrator_T
#define rtX                            simulink_wo_integrator_X
#define ContinuousStates               X_simulink_wo_integrator_T
#define rtXdot                         simulink_wo_integrator_XDot
#define StateDerivatives               XDot_simulink_wo_integrator_T
#define tXdis                          simulink_wo_integrator_XDis
#define StateDisabled                  XDis_simulink_wo_integrator_T
#define rtP                            simulink_wo_integrator_P
#define Parameters                     P_simulink_wo_integrator_T
#define rtDWork                        simulink_wo_integrator_DW
#define D_Work                         DW_simulink_wo_integrator_T

/* Parameters (default storage) */
struct P_simulink_wo_integrator_T_ {
  ...
  real_T Constant_Value_b;             /* Expression: 0.02
                                        ...
                                        */
  real_T Constant1_Value_e;            /* Expression: 0.017
...
struct tag_RTM_simulink_wo_integrato_T {
  const char_T *path;
...
extern P_simulink_wo_integrator_T simulink_wo_integrator_P;

/* Block signals (default storage) */
extern B_simulink_wo_integrator_T simulink_wo_integrator_B;

/* Continuous states (default storage) */
extern X_simulink_wo_integrator_T simulink_wo_integrator_X;

/* Block states (default storage) */
extern DW_simulink_wo_integrator_T simulink_wo_integrator_DW;
...
extern void simulink_wo_integrator_initialize(void);
extern void simulink_wo_integrator_output0(void);
extern void simulink_wo_integrator_update0(void);
extern void simulink_wo_integrator_output(int_T tid);
extern void simulink_wo_integrator_update(int_T tid);
extern void simulink_wo_integrator_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern simulink_wo_integrator_rtModel *simulink_wo_integrator(void);
...
extern RT_MODEL_simulink_wo_integrat_T *const simulink_wo_integrator_M;
 ...
 *
 * '<Root>' : 'simulink_wo_integrator'
 * '<S1>'   : 'simulink_wo_integrator/Conversion'
 * '<S2>'   : 'simulink_wo_integrator/Elevation controller'
 * '<S3>'   : 'simulink_wo_integrator/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'simulink_wo_integrator/Heli 3D'
 * '<S5>'   : 'simulink_wo_integrator/IMU system'
 * '<S6>'   : 'simulink_wo_integrator/Joystick'
 * '<S7>'   : 'simulink_wo_integrator/LQR_controller'
 * '<S8>'   : 'simulink_wo_integrator/Pitch controller'
 * '<S9>'   : 'simulink_wo_integrator/Elevation controller/Elevation controller'
 * '<S10>'  : 'simulink_wo_integrator/IMU system/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'simulink_wo_integrator/IMU system/IMU'
 * '<S12>'  : 'simulink_wo_integrator/IMU system/MATLAB Function'
 */
#endif                                /* RTW_HEADER_simulink_wo_integrator_h_ */
