 ...
 * C source code generated on : Mon Sep 15 18:43:04 2025
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  SignalConversion generated from: '<S5>/Gain'
     */
  ...
  /* SignalConversion generated from: '<S5>/Gain3' incorporates:
  ...
  for (i = 0; i < 2; i++) {
    ...
    u0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      u0 += heli_q8_P.K_aug[(i_0 << 1) + i] * tmp[i_0];
    }

    heli_q8_B.Sum[i] = heli_q8_B.Gain[i] - u0;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_m = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;
  }
   ...
   */
  heli_q8_B.Sum_o = heli_q8_B.Sum[0] + heli_q8_P.Vs_0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* SignalConversion generated from: '<Root>/To File1' */
    heli_q8_B.TmpSignalConversionAtToFile1Inp[0] = heli_q8_B.Sum[1];
    ...
    heli_q8_B.TmpSignalConversionAtToFile1Inp[5] = heli_q8_B.Sum_m;
    ...
    heli_q8_B.TmpSignalConversionAtToFile1Inp[8] = 0.0;
            ...
            if (fp != (NULL)) {
              ...
              if (fwrite(u, sizeof(real_T), 9 + 1, fp) != 9 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile1_IWORK.Count) * (9 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    allowed in MAT-file lab2_Q_1_1_20_1_1_R_1_0.5.mat.\n");
              }
            }
          }
        }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum_o - heli_q8_B.Sum[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum_o + heli_q8_B.Sum[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S5>/Sum1' */
    heli_q8_B.Sum1 = heli_q8_B.Joystick_gain_x - heli_q8_B.PitchCounttorad;
  }

  /* Sum: '<S5>/Sum2' */
  heli_q8_B.Sum2 = heli_q8_B.Joystick_gain_y - heli_q8_B.ElevationTransferFcn;
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "lab2_Q_1_1_20_1_1_R_1_0.5.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 9 + 1, 0, "ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 9 + 1, heli_q8_DW.ToFile1_IWORK.Count,
           "ans")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file lab2_Q_1_1_20_1_1_R_1_0.5.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (843386354U);
  heli_q8_M->Sizes.checksums[1] = (458552044U);
  heli_q8_M->Sizes.checksums[2] = (233624311U);
  heli_q8_M->Sizes.checksums[3] = (528612860U);
