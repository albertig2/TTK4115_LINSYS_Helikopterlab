 ...
 * C source code generated on : Mon Aug 25 18:13:13 2025
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  temp = heli_q8_P.SignalGenerator_Frequency * heli_q8_M->Timing.t[0];
  if (temp - floor(temp) >= 0.5) {
    /* SignalGenerator: '<Root>/Signal Generator' */
    heli_q8_B.SignalGenerator = heli_q8_P.SignalGenerator_Amplitude;
  } else {
    /* SignalGenerator: '<Root>/Signal Generator' */
    heli_q8_B.SignalGenerator = -heli_q8_P.SignalGenerator_Amplitude;
  }
   ...
   *  Sum: '<S5>/Sum'
   */
  heli_q8_B.Sum2 = (heli_q8_B.SignalGenerator - heli_q8_B.PitchCounttorad) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S2>/Sum'
     */
    rtb_DeadZoney = heli_q8_P.Constant1_Value - heli_q8_B.Sum;
   ...
   *  Sum: '<S6>/Sum'
   */
  heli_q8_B.Sum_o = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
                     heli_q8_P.K_ed_Gain * heli_q8_B.ElevationTransferFcn) +
    heli_q8_P.Vs_0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* SignalConversion generated from: '<Root>/To File1' */
    heli_q8_B.TmpSignalConversionAtToFile1Inp[0] = heli_q8_B.Sum2;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[1] = heli_q8_B.TravelCounttorad;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[2] = heli_q8_B.TravelTransferFcn;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[3] = heli_q8_B.PitchCounttorad;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[4] = heli_q8_B.PitchTransferFcn;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[5] = heli_q8_B.Sum;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[6] =
      heli_q8_B.ElevationTransferFcn;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[7] = heli_q8_B.Sum_o;
    heli_q8_B.TmpSignalConversionAtToFile1Inp[8] = heli_q8_B.SignalGenerator;
      ...
      if (rtmIsMajorTimeStep(heli_q8_M) ) {
        {
          if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
            ...
            if (fp != (NULL)) {
              ...
              u[4] = heli_q8_B.TmpSignalConversionAtToFile1Inp[3];
              u[5] = heli_q8_B.TmpSignalConversionAtToFile1Inp[4];
              u[6] = heli_q8_B.TmpSignalConversionAtToFile1Inp[5];
              u[7] = heli_q8_B.TmpSignalConversionAtToFile1Inp[6];
              u[8] = heli_q8_B.TmpSignalConversionAtToFile1Inp[7];
              u[9] = heli_q8_B.TmpSignalConversionAtToFile1Inp[8];
              if (fwrite(u, sizeof(real_T), 9 + 1, fp) != 9 + 1) {
                rtmSetErrorStatus(heli_q8_M,
                                  "Error writing to MAT-file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
                return;
              }
              ...
              if (((++heli_q8_DW.ToFile1_IWORK.Count) * (9 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
                              ...
                              "    allowed in MAT-file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat.\n");
              }
            }
          }
        }
   ...
   *  Sum: '<S1>/Add'
   */
  temp = (heli_q8_B.Sum_o - heli_q8_B.Sum2) * heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (temp > heli_q8_P.FrontmotorSaturation_UpperSat) {
    /* Saturate: '<S3>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (temp < heli_q8_P.FrontmotorSaturation_LowerSat) {
    /* Saturate: '<S3>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S3>/Front motor: Saturation' */
    heli_q8_B.FrontmotorSaturation = temp;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  temp = (heli_q8_B.Sum_o + heli_q8_B.Sum2) * heli_q8_P.Backgain_Gain;

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (temp > heli_q8_P.BackmotorSaturation_UpperSat) {
    /* Saturate: '<S3>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (temp < heli_q8_P.BackmotorSaturation_LowerSat) {
    /* Saturate: '<S3>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S3>/Back motor: Saturation' */
    heli_q8_B.BackmotorSaturation = temp;
  }
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "lab1_lambda1_N0.8_lambda2_N8_squarewave.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 9 + 1, 0, "ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 9 + 1, heli_q8_DW.ToFile1_IWORK.Count,
           "ans")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file lab1_lambda1_N0.8_lambda2_N8_squarewave.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1162236269U);
  heli_q8_M->Sizes.checksums[1] = (3960467426U);
  heli_q8_M->Sizes.checksums[2] = (2515804276U);
  heli_q8_M->Sizes.checksums[3] = (420828032U);
...

  {
    int32_T i;
    for (i = 0; i < 9; i++) {
      heli_q8_B.TmpSignalConversionAtToFile1Inp[i] = 0.0;
    }

    heli_q8_B.SignalGenerator = 0.0;
