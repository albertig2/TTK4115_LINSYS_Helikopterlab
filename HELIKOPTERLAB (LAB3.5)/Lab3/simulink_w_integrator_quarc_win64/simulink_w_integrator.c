 ...
 * C source code generated on : Fri Oct 10 11:04:12 2025
 *
...
#include "simulink_w_integrator_dt.h"
...
void simulink_w_integrator_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(simulink_w_integrator_M)) {
    ...
    {
      t_error result = 0;
      t_boolean close_flag = (simulink_w_integrator_P.Constant_Value != 0);
    ...
    for (i = 0; i < 3; i++) {
      /* Gain: '<S11>/Gain2' */
      simulink_w_integrator_B.Gain2[i] = 0.0;
      simulink_w_integrator_B.Gain2[i] += simulink_w_integrator_P.Gain2_Gain[i] *
        simulink_w_integrator_B.Switch[0];
      simulink_w_integrator_B.Gain2[i] += simulink_w_integrator_P.Gain2_Gain[i +
        3] * simulink_w_integrator_B.Switch[1];
      simulink_w_integrator_B.Gain2[i] += simulink_w_integrator_P.Gain2_Gain[i +
        6] * simulink_w_integrator_B.Switch[2];
    }
    ...
    if (simulink_w_integrator_B.RateTransitionx >
      ...
      tmp_3 = simulink_w_integrator_B.RateTransitionx -
        simulink_w_integrator_P.DeadZonex_End;
    ...
    simulink_w_integrator_B.Joystick_gain_x = simulink_w_integrator_P.Gainx_Gain
      * tmp_3 * simulink_w_integrator_P.Joystick_gain_x;
  }

  for (i = 0; i < 5; i++) {
    /* Integrator: '<S3>/Integrator' */
    simulink_w_integrator_B.Integrator[i] =
  ...
  if (rtmIsMajorTimeStep(simulink_w_integrator_M)) {
    ...
    if (simulink_w_integrator_B.RateTransitiony >
      ...
      tmp_3 = simulink_w_integrator_B.RateTransitiony -
        simulink_w_integrator_P.DeadZoney_End;
    ...
    simulink_w_integrator_B.Joystick_gain_y = simulink_w_integrator_P.Gainy_Gain
      * tmp_3 * simulink_w_integrator_P.Joystick_gain_y;
  }

  /* End of RateTransition: '<S6>/Rate Transition: y' */

  /* SignalConversion generated from: '<S7>/Gain' incorporates:
   *  Sum: '<S7>/Sum3'
   *  Sum: '<S7>/Sum4'
   */
  tmp_3 = simulink_w_integrator_B.Joystick_gain_x -
    simulink_w_integrator_B.Integrator[0];
  tmp_4 = simulink_w_integrator_B.Joystick_gain_y -
    simulink_w_integrator_B.Integrator[3];

  /* SignalConversion generated from: '<S7>/Gain3' incorporates:
   *  Integrator: '<S7>/Integrator'
   *  Integrator: '<S7>/Integrator1'
   */
  tmp[2] = simulink_w_integrator_B.Integrator[3];
  tmp[3] = simulink_w_integrator_X.Integrator_CSTATE_m;
  tmp[4] = simulink_w_integrator_X.Integrator1_CSTATE;
  tmp[0] = simulink_w_integrator_B.Integrator[0];

  /* Gain: '<S7>/Gain' */
  tmp_0[0] = simulink_w_integrator_P.F[0] * tmp_3 + simulink_w_integrator_P.F[2]
    * tmp_4;

  /* SignalConversion generated from: '<S7>/Gain3' */
  tmp[1] = simulink_w_integrator_B.Integrator[1];

  /* Gain: '<S7>/Gain' */
  tmp_0[1] = simulink_w_integrator_P.F[1] * tmp_3;
  tmp_0[1] += simulink_w_integrator_P.F[3] * tmp_4;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S7>/Gain3' */
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
    ...
    /* Sum: '<S7>/Sum' */
    simulink_w_integrator_B.Sum[i] = tmp_0[i] - tmp_1[i];
  }
  ...
  simulink_w_integrator_B.TravelTransferFcn = 0.0;
  ...
  simulink_w_integrator_B.PitchTransferFcn = 0.0;
  ...
  if (rtmIsMajorTimeStep(simulink_w_integrator_M)) {
     ...
     */
    simulink_w_integrator_B.Sum_m = simulink_w_integrator_B.ElevationCounttorad
      - simulink_w_integrator_P.Constant_Value_p;
  }

  /* TransferFcn: '<S4>/Elevation: Transfer Fcn' */
  simulink_w_integrator_B.ElevationTransferFcn = 0.0;
   ...
   */
  simulink_w_integrator_B.Sum_o = simulink_w_integrator_B.Sum[0] +
    simulink_w_integrator_P.Vs_0;
  if (rtmIsMajorTimeStep(simulink_w_integrator_M)) {
    for (i = 0; i < 3; i++) {
      /* Gain: '<S11>/Gain1' */
      simulink_w_integrator_B.Gain1[i] = 0.0;
      simulink_w_integrator_B.Gain1[i] += simulink_w_integrator_P.Gain1_Gain[i] *
        simulink_w_integrator_B.Switch[3];
      simulink_w_integrator_B.Gain1[i] += simulink_w_integrator_P.Gain1_Gain[i +
        3] * simulink_w_integrator_B.Switch[4];
      simulink_w_integrator_B.Gain1[i] += simulink_w_integrator_P.Gain1_Gain[i +
        6] * simulink_w_integrator_B.Switch[5];
    }

    /* MATLAB Function: '<S5>/MATLAB Function' */
    tmp_3 = simulink_w_integrator_B.Gain2[1];
    tmp_4 = simulink_w_integrator_B.Gain2[2];

    /* MATLAB Function 'IMU system/MATLAB Function': '<S12>:1' */
    if (simulink_w_integrator_B.Gain2[2] == 0.0) {
      /* '<S12>:1:2' */
      /* '<S12>:1:3' */
      tmp_4 = 0.01;
      if (simulink_w_integrator_B.Gain2[1] == 0.0) {
        /* '<S12>:1:4' */
        /* '<S12>:1:5' */
        tmp_3 = 0.01;
      }
    ...
    /* '<S12>:1:8' */
    /* '<S12>:1:9' */
    simulink_w_integrator_B.p = atan(tmp_3 / tmp_4) +
     ...
     *  MATLAB Function: '<S5>/MATLAB Function'
     */
    simulink_w_integrator_B.e = atan(simulink_w_integrator_B.Gain2[0] / sqrt
    ...
    /* '<S10>:1:8' */
    /* '<S10>:1:11' */
    tmp_3 = tan(simulink_w_integrator_B.e);
    tmp_4 = sin(simulink_w_integrator_B.p);
    euler_rates_tmp = cos(simulink_w_integrator_B.p);
    euler_rates_tmp_0 = cos(simulink_w_integrator_B.e);
    tmp_2[0] = 1.0;
    tmp_2[3] = tmp_4 * tmp_3;
    tmp_2[6] = euler_rates_tmp * tmp_3;
    tmp_2[1] = 0.0;
    tmp_2[4] = euler_rates_tmp;
    tmp_2[7] = -tmp_4;
    tmp_2[2] = 0.0;
    tmp_2[5] = tmp_4 / euler_rates_tmp_0;
    tmp_2[8] = euler_rates_tmp / euler_rates_tmp_0;
    for (i = 0; i < 3; i++) {
      simulink_w_integrator_B.euler_rates[i] = 0.0;
      simulink_w_integrator_B.euler_rates[i] += tmp_2[i] *
        simulink_w_integrator_B.Gain1[0];
      simulink_w_integrator_B.euler_rates[i] += tmp_2[i + 3] *
        simulink_w_integrator_B.Gain1[1];
      simulink_w_integrator_B.euler_rates[i] += tmp_2[i + 6] *
        simulink_w_integrator_B.Gain1[2];
    }

    /* End of MATLAB Function: '<S5>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
    /* SignalConversion generated from: '<Root>/To File2' */
    rtb_TmpSignalConversionAtToFile[0] = simulink_w_integrator_B.p;
    rtb_TmpSignalConversionAtToFile[1] = simulink_w_integrator_B.euler_rates[0];
    rtb_TmpSignalConversionAtToFile[2] = simulink_w_integrator_B.e;
    rtb_TmpSignalConversionAtToFile[3] = simulink_w_integrator_B.euler_rates[1];
    rtb_TmpSignalConversionAtToFile[4] = simulink_w_integrator_B.euler_rates[2];
    for (i = 0; i < 5; i++) {
      rtb_TmpSignalConversionAtToFile[i + 5] =
        simulink_w_integrator_B.Integrator[i];
    }

    rtb_TmpSignalConversionAtToFile[10] =
      simulink_w_integrator_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtToFile[11] =
    ...
    if (rtmIsMajorTimeStep(simulink_w_integrator_M)) {
      if (rtmIsMajorTimeStep(simulink_w_integrator_M) ) {
        {
          if (!(++simulink_w_integrator_DW.ToFile2_IWORK.Decimation % 1) &&
              (simulink_w_integrator_DW.ToFile2_IWORK.Count * (12 + 1)) + 1 <
              100000000 ) {
            FILE *fp = (FILE *) simulink_w_integrator_DW.ToFile2_PWORK.FilePtr;
            if (fp != (NULL)) {
              real_T u[12 + 1];
              simulink_w_integrator_DW.ToFile2_IWORK.Decimation = 0;
              u[0] = simulink_w_integrator_M->Timing.t[1];
              ...
              if (fwrite(u, sizeof(real_T), 12 + 1, fp) != 12 + 1) {
                rtmSetErrorStatus(simulink_w_integrator_M,
                                  "Error writing to MAT-file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
                return;
              }

              if (((++simulink_w_integrator_DW.ToFile2_IWORK.Count) * (12 + 1))+
                  1 >= 100000000) {
                (void)fprintf(stdout,
                              "*** The ToFile block will stop logging data before\n"
                              "    the simulation has ended, because it has reached\n"
                              "    the maximum number of elements (100000000)\n"
                              "    allowed in MAT-file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat.\n");
              }
            }
          }
        }
  ...
  for (i = 0; i < 5; i++) {
    ...
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Sum1[i] += simulink_w_integrator_P.C_est[5 * i_0 + i] *
        simulink_w_integrator_B.Integrator[i_0];
    }
  }
  ...
  /* Sum: '<S3>/Sum1' */
  tmp[0] = simulink_w_integrator_B.p - rtb_Sum1[0];
  tmp[1] = simulink_w_integrator_B.euler_rates[0] - rtb_Sum1[1];
  tmp[2] = simulink_w_integrator_B.e - rtb_Sum1[2];
  ...
  for (i = 0; i < 5; i++) {
    ...
    for (i_0 = 0; i_0 < 5; i_0++) {
       ...
       *  Gain: '<S3>/A_est'
       */
      tmp_3 += simulink_w_integrator_P.A_est[tmp_5] *
        simulink_w_integrator_B.Integrator[i_0];

      /* Gain: '<S3>/Gain1' */
      tmp[i] += simulink_w_integrator_P.L[tmp_5] * rtb_Sum1[i_0];
    }
    ...
    simulink_w_integrator_B.Sum_p[i] = (tmp[i] +
      (simulink_w_integrator_P.B_est[i + 5] * simulink_w_integrator_B.Sum[1] +
       simulink_w_integrator_P.B_est[i] * simulink_w_integrator_B.Sum[0])) +
      tmp_3;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  tmp_3 = (simulink_w_integrator_B.Sum_o - simulink_w_integrator_B.Sum[1]) *
    simulink_w_integrator_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (tmp_3 > simulink_w_integrator_P.FrontmotorSaturation_UpperSat) {
    /* Saturate: '<S4>/Front motor: Saturation' */
    simulink_w_integrator_B.FrontmotorSaturation =
      simulink_w_integrator_P.FrontmotorSaturation_UpperSat;
  } else if (tmp_3 < simulink_w_integrator_P.FrontmotorSaturation_LowerSat) {
    /* Saturate: '<S4>/Front motor: Saturation' */
    simulink_w_integrator_B.FrontmotorSaturation =
      simulink_w_integrator_P.FrontmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S4>/Front motor: Saturation' */
    simulink_w_integrator_B.FrontmotorSaturation = tmp_3;
  }
  ...
  if (tmp_3 > simulink_w_integrator_P.BackmotorSaturation_UpperSat) {
    /* Saturate: '<S4>/Back motor: Saturation' */
    simulink_w_integrator_B.BackmotorSaturation =
      simulink_w_integrator_P.BackmotorSaturation_UpperSat;
  } else if (tmp_3 < simulink_w_integrator_P.BackmotorSaturation_LowerSat) {
    /* Saturate: '<S4>/Back motor: Saturation' */
    simulink_w_integrator_B.BackmotorSaturation =
      simulink_w_integrator_P.BackmotorSaturation_LowerSat;
  } else {
    /* Saturate: '<S4>/Back motor: Saturation' */
    simulink_w_integrator_B.BackmotorSaturation = tmp_3;
  }
  ...
  /* Sum: '<S7>/Sum1' */
  simulink_w_integrator_B.Sum1 = simulink_w_integrator_B.Joystick_gain_x -
    simulink_w_integrator_B.Integrator[0];

  /* Sum: '<S7>/Sum2' */
  simulink_w_integrator_B.Sum2 = simulink_w_integrator_B.Joystick_gain_y -
    simulink_w_integrator_B.Integrator[3];
...
void simulink_w_integrator_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE_m = simulink_w_integrator_B.Sum1;
...
void simulink_w_integrator_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(simulink_w_integrator_M,
                        "Error creating .mat file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 12 + 1, 0, "ans")) {
      rtmSetErrorStatus(simulink_w_integrator_M,
                        "Error writing mat file header to file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
      return;
    }

    simulink_w_integrator_DW.ToFile2_IWORK.Count = 0;
    simulink_w_integrator_DW.ToFile2_IWORK.Decimation = -1;
    simulink_w_integrator_DW.ToFile2_PWORK.FilePtr = fp;
  }
...
void simulink_w_integrator_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File2' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(simulink_w_integrator_M,
                          "Error closing MAT-file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(simulink_w_integrator_M,
                          "Error reopening MAT-file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 12 + 1,
           simulink_w_integrator_DW.ToFile2_IWORK.Count, "ans")) {
        rtmSetErrorStatus(simulink_w_integrator_M,
                          "Error writing header for ans to MAT-file lab3_p_N20_N15_N13_N17_N20_Q_30_20_15_5_5_R_1_1.mat");
      }
      ...
      simulink_w_integrator_DW.ToFile2_PWORK.FilePtr = (NULL);
    }
  }
...
RT_MODEL_simulink_w_integrato_T *simulink_w_integrator(void)
{
  ...
  /* External mode info */
  simulink_w_integrator_M->Sizes.checksums[0] = (2973925474U);
  simulink_w_integrator_M->Sizes.checksums[1] = (4158263358U);
  simulink_w_integrator_M->Sizes.checksums[2] = (3632371403U);
  simulink_w_integrator_M->Sizes.checksums[3] = (156995422U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[4];
    simulink_w_integrator_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    systemRan[1] = &rtAlwaysEnabled;
    systemRan[2] = &rtAlwaysEnabled;
    systemRan[3] = &rtAlwaysEnabled;
    rteiSetModelMappingInfoPtr(simulink_w_integrator_M->extModeInfo,
      &simulink_w_integrator_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(simulink_w_integrator_M->extModeInfo,
                        simulink_w_integrator_M->Sizes.checksums);
    rteiSetTPtr(simulink_w_integrator_M->extModeInfo, rtmGetTPtr
                (simulink_w_integrator_M));
  }
  ...
  (void) memset(((void *) &simulink_w_integrator_B), 0,
                sizeof(B_simulink_w_integrator_T));

  {
    ...
    for (i = 0; i < 5; i++) {
      simulink_w_integrator_B.Integrator[i] = 0.0;
    }
    ...
    simulink_w_integrator_B.Gain2[0] = 0.0;
    simulink_w_integrator_B.Gain2[1] = 0.0;
    simulink_w_integrator_B.Gain2[2] = 0.0;
    ...
    simulink_w_integrator_B.Sum[0] = 0.0;
    simulink_w_integrator_B.Sum[1] = 0.0;
    ...
    simulink_w_integrator_B.Sum_m = 0.0;
    simulink_w_integrator_B.ElevationTransferFcn = 0.0;
    simulink_w_integrator_B.Sum_o = 0.0;
    simulink_w_integrator_B.Gain1[0] = 0.0;
    simulink_w_integrator_B.Gain1[1] = 0.0;
    simulink_w_integrator_B.Gain1[2] = 0.0;
    simulink_w_integrator_B.p = 0.0;
    simulink_w_integrator_B.e = 0.0;
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    simulink_w_integrator_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  simulink_w_integrator_M->Sizes.numBlocks = (90);/* Number of blocks */
  simulink_w_integrator_M->Sizes.numBlockIO = (27);/* Number of block outputs */
  simulink_w_integrator_M->Sizes.numBlockPrms = (538);/* Sum of parameter "widths" */
