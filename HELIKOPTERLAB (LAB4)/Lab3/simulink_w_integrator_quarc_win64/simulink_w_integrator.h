...
#ifndef RTW_HEADER_simulink_w_integrator_h_
#define RTW_HEADER_simulink_w_integrator_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef simulink_w_integrator_COMMON_INCLUDES_
#define simulink_w_integrator_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                              /* simulink_w_integrator_COMMON_INCLUDES_ */

#include "simulink_w_integrator_types.h"
...
#define simulink_w_integrator_rtModel  RT_MODEL_simulink_w_integrato_T
...
typedef struct {
  ...
  real_T Integrator[5];                /* '<S3>/Integrator' */
...
} DW_simulink_w_integrator_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE[5];         /* '<S3>/Integrator' */
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S4>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE_n;          /* '<S9>/Integrator' */
} XDot_simulink_w_integrator_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[5];      /* '<S3>/Integrator' */
...
#define rtB                            simulink_w_integrator_B
#define BlockIO                        B_simulink_w_integrator_T
#define rtX                            simulink_w_integrator_X
#define ContinuousStates               X_simulink_w_integrator_T
#define rtXdot                         simulink_w_integrator_XDot
#define StateDerivatives               XDot_simulink_w_integrator_T
#define tXdis                          simulink_w_integrator_XDis
#define StateDisabled                  XDis_simulink_w_integrator_T
#define rtP                            simulink_w_integrator_P
#define Parameters                     P_simulink_w_integrator_T
#define rtDWork                        simulink_w_integrator_DW
#define D_Work                         DW_simulink_w_integrator_T

/* Parameters (default storage) */
struct P_simulink_w_integrator_T_ {
  ...
  real_T Gain1_Gain[9];             /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                     ...
                                     */
  real_T Constant_Value_g;             /* Expression: 0.02
...
struct tag_RTM_simulink_w_integrator_T {
  const char_T *path;
...
extern P_simulink_w_integrator_T simulink_w_integrator_P;

/* Block signals (default storage) */
extern B_simulink_w_integrator_T simulink_w_integrator_B;

/* Continuous states (default storage) */
extern X_simulink_w_integrator_T simulink_w_integrator_X;

/* Block states (default storage) */
extern DW_simulink_w_integrator_T simulink_w_integrator_DW;
...
extern void simulink_w_integrator_initialize(void);
extern void simulink_w_integrator_output0(void);
extern void simulink_w_integrator_update0(void);
extern void simulink_w_integrator_output(int_T tid);
extern void simulink_w_integrator_update(int_T tid);
extern void simulink_w_integrator_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern simulink_w_integrator_rtModel *simulink_w_integrator(void);
...
extern RT_MODEL_simulink_w_integrato_T *const simulink_w_integrator_M;
 ...
 *
 * '<Root>' : 'simulink_w_integrator'
 * '<S1>'   : 'simulink_w_integrator/Conversion'
 * '<S2>'   : 'simulink_w_integrator/Elevation controller'
 * '<S3>'   : 'simulink_w_integrator/Estimator'
 * '<S4>'   : 'simulink_w_integrator/Heli 3D'
 * '<S5>'   : 'simulink_w_integrator/IMU system'
 * '<S6>'   : 'simulink_w_integrator/Joystick'
 * '<S7>'   : 'simulink_w_integrator/LQR_controller'
 * '<S8>'   : 'simulink_w_integrator/Pitch controller'
 * '<S9>'   : 'simulink_w_integrator/Elevation controller/Elevation controller'
 * '<S10>'  : 'simulink_w_integrator/IMU system/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'simulink_w_integrator/IMU system/IMU'
 * '<S12>'  : 'simulink_w_integrator/IMU system/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_simulink_w_integrator_h_ */
