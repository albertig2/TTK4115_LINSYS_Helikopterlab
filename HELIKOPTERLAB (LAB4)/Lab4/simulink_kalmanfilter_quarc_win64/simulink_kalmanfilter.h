...
#ifndef RTW_HEADER_simulink_kalmanfilter_h_
#define RTW_HEADER_simulink_kalmanfilter_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef simulink_kalmanfilter_COMMON_INCLUDES_
#define simulink_kalmanfilter_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                              /* simulink_kalmanfilter_COMMON_INCLUDES_ */

#include "simulink_kalmanfilter_types.h"
...
#define simulink_kalmanfilter_rtModel  RT_MODEL_simulink_kalmanfilte_T

/* Block signals (default storage) */
typedef struct {
  real_T RateTransitionx;              /* '<S5>/Rate Transition: x' */
  real_T Joystick_gain_x;              /* '<S5>/Joystick_gain_x' */
  real_T x_bar[6];                     /* '<Root>/Unit Delay' */
  real_T Switch[10];                   /* '<S12>/Switch' */
  real_T p;                            /* '<S4>/Sum' */
  real_T Gain1[3];                     /* '<S12>/Gain1' */
  real_T e;                            /* '<S4>/Sum1' */
  ...
  real_T y_vector[5];                  /* '<Root>/IMU system' */
  ...
  real_T x_bar_k[6];                   /* '<Root>/prediction' */
  real_T P_bar[36];                    /* '<Root>/prediction' */
  real_T x_hat[6];                     /* '<Root>/correction' */
  real_T P_hat[36];                    /* '<Root>/correction' */
  real_T euler_rates[3];
           /* '<S4>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
  uint8_T StreamCall1_o2;              /* '<S12>/Stream Call1' */
} B_simulink_kalmanfilter_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData[4];
  } IMU_v_Enc_PWORK;                   /* '<Root>/IMU_v_Enc' */
  ...
  uint8_T StreamCall1_State;           /* '<S12>/Stream Call1' */
} DW_simulink_kalmanfilter_T;
...
#define rtB                            simulink_kalmanfilter_B
#define BlockIO                        B_simulink_kalmanfilter_T
#define rtX                            simulink_kalmanfilter_X
#define ContinuousStates               X_simulink_kalmanfilter_T
#define rtXdot                         simulink_kalmanfilter_XDot
#define StateDerivatives               XDot_simulink_kalmanfilter_T
#define tXdis                          simulink_kalmanfilter_XDis
#define StateDisabled                  XDis_simulink_kalmanfilter_T
#define rtP                            simulink_kalmanfilter_P
#define Parameters                     P_simulink_kalmanfilter_T
#define rtDWork                        simulink_kalmanfilter_DW
#define D_Work                         DW_simulink_kalmanfilter_T

/* Parameters (default storage) */
struct P_simulink_kalmanfilter_T_ {
  real_T Ad[36];                       /* Variable: Ad
                                        * Referenced by: '<Root>/Constant4'
                                        */
  real_T Bd[12];                       /* Variable: Bd
                                        * Referenced by: '<Root>/Constant5'
                                        */
  real_T Cd[30];                       /* Variable: Cd
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_LQR[10];                    /* Variable: K_LQR
                                        * Referenced by: '<S6>/Gain3'
                                        */
  real_T Qd[36];                       /* Variable: Qd
                                        * Referenced by: '<Root>/Constant6'
                                        */
  real_T Rd[25];                       /* Variable: Rd
  ...
  real_T Gain1_Gain[9];             /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                     ...
                                     */
  real_T Constant1_Value_n;            /* Expression: 0.017
...
struct tag_RTM_simulink_kalmanfilter_T {
  const char_T *path;
...
extern P_simulink_kalmanfilter_T simulink_kalmanfilter_P;

/* Block signals (default storage) */
extern B_simulink_kalmanfilter_T simulink_kalmanfilter_B;

/* Continuous states (default storage) */
extern X_simulink_kalmanfilter_T simulink_kalmanfilter_X;

/* Block states (default storage) */
extern DW_simulink_kalmanfilter_T simulink_kalmanfilter_DW;
...
extern void simulink_kalmanfilter_initialize(void);
extern void simulink_kalmanfilter_output0(void);
extern void simulink_kalmanfilter_update0(void);
extern void simulink_kalmanfilter_output(int_T tid);
extern void simulink_kalmanfilter_update(int_T tid);
extern void simulink_kalmanfilter_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern simulink_kalmanfilter_rtModel *simulink_kalmanfilter(void);
...
extern RT_MODEL_simulink_kalmanfilte_T *const simulink_kalmanfilter_M;
 ...
 *
 * '<Root>' : 'simulink_kalmanfilter'
 * '<S1>'   : 'simulink_kalmanfilter/Conversion'
 * '<S2>'   : 'simulink_kalmanfilter/Elevation controller'
 * '<S3>'   : 'simulink_kalmanfilter/Heli 3D'
 * '<S4>'   : 'simulink_kalmanfilter/IMU system'
 * '<S5>'   : 'simulink_kalmanfilter/Joystick'
 * '<S6>'   : 'simulink_kalmanfilter/LQR_controller'
 * '<S7>'   : 'simulink_kalmanfilter/Pitch controller'
 * '<S8>'   : 'simulink_kalmanfilter/correction'
 * '<S9>'   : 'simulink_kalmanfilter/prediction'
 * '<S10>'  : 'simulink_kalmanfilter/Elevation controller/Elevation controller'
 * '<S11>'  : 'simulink_kalmanfilter/IMU system/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S12>'  : 'simulink_kalmanfilter/IMU system/IMU'
 * '<S13>'  : 'simulink_kalmanfilter/IMU system/MATLAB Function'
 */
#endif                                 /* RTW_HEADER_simulink_kalmanfilter_h_ */
